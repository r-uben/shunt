...
<Aside type="note" title="Claude Desktop 的网关配置由管理员管理，而不是用户文件">
...
<Aside type="caution" title="shunt 未实现 Claude Desktop 的 SSO 契约">
...
<Aside type="note" title="尚未输出 `anthropic_family_tier`">
