...
<Aside type="note" title="Claude Desktop의 게이트웨이 구성은 사용자 파일이 아닌 관리형 설정입니다">
...
<Aside type="caution" title="shunt는 Claude Desktop의 SSO 계약을 구현하지 않습니다">
...
<Aside type="note" title="`anthropic_family_tier`는 아직 출력되지 않습니다">
