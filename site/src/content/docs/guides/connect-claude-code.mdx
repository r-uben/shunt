...
<Aside type="note" title="On a shared gateway">
...
<Aside type="caution" title="The refresh trap">
...
<Aside type="note" title="Why this authenticates Claude passthrough">
...
<Aside type="tip" title="Or remap the tier aliases">
